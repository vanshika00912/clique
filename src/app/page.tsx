...
const perks = [
  {
    ...
    description:
      'Get the images delivered to your email in seconds and download them right away.',
  },
  {
    name: 'Verified Images',
    Icon: CheckCircle,
    description:
      'Every image on our platform is verified by our team to ensure our quality standards. Not happy? We offer a 30-day refund guarantee.',
  },
  {
    name: 'For the Planet',
    Icon: Leaf,
