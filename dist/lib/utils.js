...
function constructMetadata(_a) {
    var _b = _a === void 0 ? {} : _a, _c = _b.title, title = _c === void 0 ? 'Clique - the marketplace for Images' : _c, _d = _b.description, description = _d === void 0 ? 'Clique is an open-source marketplace for high-quality Images.' : _d, _e = _b.image, image = _e === void 0 ? '/thumbnail.png' : _e, _f = _b.icons, icons = _f === void 0 ? '/favicon.ico' : _f, _g = _b.noIndex, noIndex = _g === void 0 ? false : _g;
    return __assign({ title: title, description: description, openGraph: {
            ...
            description: description,
            images: [image],
            creator: '@bhaumikreddy',
        }, icons: icons, metadataBase: new URL('https://cliqueproject.up.railway.app/') }, (noIndex && {
        robots: {
            index: false,
            follow: false,
        },
